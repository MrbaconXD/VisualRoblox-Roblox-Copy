local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/Synx-dev/VisualRoblox-Roblox-Copy/main/UI-Libraries/Visual%20UI%20Library/Source.lua'))()
